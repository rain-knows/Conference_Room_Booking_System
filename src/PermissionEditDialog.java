...
public class PermissionEditDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        roomTypeLabel.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        permissionsLabel.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        new SwingWorker<Boolean, Void>() {
            ...
            protected void done() {
                try {
                    if (get()) {
                        confirmed = true;
                        JOptionPane.showMessageDialog(PermissionEditDialog.this, "权限映射保存成功！", "成功",
                                JOptionPane.INFORMATION_MESSAGE);
                        dispose();
                    } else {
                        JOptionPane.showMessageDialog(PermissionEditDialog.this, "保存失败。", "错误",
                                JOptionPane.ERROR_MESSAGE);
                    }
                } catch (Exception e) {
                    JOptionPane.showMessageDialog(PermissionEditDialog.this, "保存时发生错误: " + e.getMessage(), "数据库错误",
                            JOptionPane.ERROR_MESSAGE);
                }
            }
        }.execute();
