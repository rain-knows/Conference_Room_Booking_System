...
public class RoomTypeEditDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        typeNameField.setBorder(BorderFactory.createCompoundBorder(
        ...
        codeLabel.setForeground(new Color(52, 73, 94));
        ...
        typeCodeField.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(new Color(206, 212, 218), 1),
                BorderFactory.createEmptyBorder(6, 10, 6, 10)));
        add(codeLabel);
